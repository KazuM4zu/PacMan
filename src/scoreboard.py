...
class ScoreView(arcade.View):
    ...
    def load_scoreboard(self):
        ...
        for i, (name, score) in enumerate(scores_tries[:5]):
    ...
    def on_draw(self):
        ...
        if self.back_selected:
            ...
            triangle_x = self.menu_center_x - (txt_width // 2) - 30
    ...
    def on_mouse_motion(self, x, y, dx, dy):
        ...
        left = self.menu_center_x - hitbox_w // 2
        right = self.menu_center_x + hitbox_w // 2
